package com.dandan.danvesting.post.like;
...
public class LikeRestController {
	...
	public Map<String, String> addPostLike(
		...
		boolean minusPlusLike = likeBO.PostLike(postId, userTablePK, nickName);
	...
	@GetMapping("/content/dislike")
	public Map<String, String> addPostDislike(
			@RequestParam("postId") int postId,
			HttpServletRequest request) {
		...
		boolean minusPlusDislike = likeBO.PostDislike(postId, userTablePK, nickName);
